  ...
  const testimonials = [
    {
      ...
      role: "Patient",
      content:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Qui expedita dolore accusamus!",
      rating: 5,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div
            ...
            // this inline style moves the carousel to the left, revealing the next item
          >
        ...
        <div className="mt-16 text-center">
          <button className="px-8 py-3 bg-sky-800 text-white rounded-full font-medium hover:bg-sky-700 transition-colors duration-300 shadow-lg hover:shadow-xl">
